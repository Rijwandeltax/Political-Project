...
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
	...
	<div class="container-fluid" style="padding-top:35px; padding-bottom:15px; margin-top:110px; margin-left:10%; margin-right:10%">
...
Phosfluorescently expedite functional products via premium action items.</p>
	...
	<ul>
	<a href="mission.php" style="color:#584343;">Vision</a>
	<hr  style="margin-top:1px"/>
	<a href="goal_mission.php" style="color:#FFFFFF">Our Goal</a>
	<hr  style="margin-top:1px" />
	<a href="mission_vision.php" style="color:#FFFFFF">Our Mission</a>
	<hr  style="margin-top:1px" />
	<a href="other_mission.php" style="color:#FFFFFF;">Other</a>
	<hr  style="margin-top:1px" />
	</ul></div></div>
	</div>
	<div class="col-sm-8">
	...
	<div style="margin-top:30px; padding-left:30%">You can download our Mission & Vision <a href="pdf/Bharatiya Krantikari Dal.pdf" style="float:right">DOWNLOAD HEAR</a></div>
	</div>
