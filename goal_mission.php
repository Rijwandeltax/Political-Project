...
Phosfluorescently expedite functional products via premium action items.</p>
	...
	<ul>
	<a href="mission.php" style="color:#FFFFFF;">Vision</a>
	<hr  style="margin-top:1px"/>
	<a href="goal_mission.php" style="color:#584343">Our Goal</a>
	<hr  style="margin-top:1px" />
	...
	<div class="col-sm-6" style="margin-bottom:2%;  padding:20px 20px 20px 20px;">
	our goal...
	</div>
