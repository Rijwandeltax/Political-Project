...
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
	...
	<li><a href="mediapic.php" class="active">Photo</a></li>
	<li><a href="#">TV</a></li>
	<li><a href="media.php" >Events</a></li>
	<li><a href="mediaspeech.php" >Speeches</a></li></ul>
	</div>
	<div class="container-fluid" style="padding-right:8%; padding-left:8%; margin-bottom:5%">
	<div id="msg">
	<div class="row">
		<?php
		include("poli.php");
