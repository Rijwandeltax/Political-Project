...
<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
	...
	<h2 style="text-align:center">MEDIA</h2><hr class="colored" /><br />
	<ul id="filter" style="margin-left:26%">
	<li><a href="mediapress.php" >Press Releases</a></li>
	<li><a href="mediapic.php">Photo</a></li>
	<li><a href="#">TV</a></li>
	<li><a href="media.php" class="active">Events</a></li>
	<li><a href="mediaspeech.php">Speeches</a></li></ul>
	</div>

	<div class="container-fluid" style="padding-right:10%; padding-left:10%; margin-bottom:5%">
		<div id="msg">
